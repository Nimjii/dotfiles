...
return {
  ...
  keys = {
    { '<leader><space>', mode = 'n', function () require('snipe').create_menu_toggler(producers.buffer_menu, callbacks.buffer_menu)() end, desc = 'Open buffer menu' },
  },
}
